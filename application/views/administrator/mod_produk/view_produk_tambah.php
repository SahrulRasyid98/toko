    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Biaya Pesan</th>             <td><input type='number' class='form-control' name='h'></td></tr>
                    <tr><th scope='row'>Biaya Simpan (%)</th>             <td><input type='number' class='form-control' name='hh'></td></tr>
