    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Biaya Pesan</th>             <td><input type='number' class='form-control' name='h' value='$rows[biaya_pesan]'></td></tr>
                    <tr><th scope='row'>Biaya Simpan (%)</th>             <td><input type='number' class='form-control' name='hh' value='$rows[biaya_simpan]'></td></tr>
